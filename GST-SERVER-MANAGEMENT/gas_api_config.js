...
const GAS_API = (function () {
  ...
  function getUrl() {
    ...
    const oldKey = 'https://script.google.com/macros/s/AKfycbygnpuU6tzp1gaUDYKsbtIGYsBZ4BWm5qmMx04vxoe5aQCxmWvl3mwZxCnQsCX_74MLKA/exec';
    const oldVal = localStorage.getItem(oldKey);
    if (oldVal && oldVal.startsWith('https://')) {
      localStorage.setItem(STORAGE_KEY, oldVal.trim());
      localStorage.removeItem(oldKey);
      console.info('[GAS API] Migrated old GST URL configuration to new key.');
    }
